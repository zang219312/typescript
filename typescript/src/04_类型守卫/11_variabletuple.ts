const [username, age, ...rest]: [name_: string, age_: number,
...
// const arr3: (string | number)[] = [10, 30, 40, "abc", 30] as const
// 类型 "readonly [10, 30, 40, "abc", 30]" 为 "readonly"，不能分配给可变类型 "(string | number)[]"
// arr3[0]=100

const [x, ...y] = [10, 30, 40, 60, "abc"]
console.log("x:", x)
console.log("y:", y)

const constNum = [10, 30, 40, 60, "abc"]
const [x1, ...y1] = constNum
console.log("x1:", x1)
console.log("y1:", y1)

/*const constNum2 = [10, 30, 40, 60, "abc"]
const [x2, ...y2]: (string | number)[] = constNum2
console.log("x2:", x2)
console.log("y2:", y2)*/

/*// constNum2的第一个值可能是字符串
const constNum2 = [10, 30, 40, 60, "abc"]
//错误:不能将类型“(string | number)[]”分配给类型“[number, ...any[]]”。
const [x2, ...y2]: [number, ...any[]] = constNum2// 错误
console.log("x2:", x2)
console.log("y2:", y2)*/

const constNum2 = ["df", 30, 40, 60, "abc"]
//  把元组退化成"数组"
const [x2, ...y2]: [...any[]] = constNum2// 错误
console.log("x2:", x2)
console.log("y2:", y2)

const constNum3 = [10, 30, 40, 60, "abc"] as const
//  把元组退化成"数组"
const [x3, ...y3]: readonly [any, ...any[]] = constNum3// 错误
console.log("x3:", x3)
console.log("y3:", y3)
